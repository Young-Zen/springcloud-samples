...
public class FeignRequestInterceptor implements RequestInterceptor {
    ...
    public void apply(RequestTemplate requestTemplate) {
        ...
        requestTemplate.header(
                ConstantForHttpHeader.AUTHORIZATION,
                httpServletRequest.getHeader(ConstantForHttpHeader.AUTHORIZATION));
        ...
        requestTemplate.header(
                ConstantForHttpHeader.LOG_IGNORE_TRACING,
                LogHolder.getLogDto().getIsIgnoreTracing().toString());
    }
}
